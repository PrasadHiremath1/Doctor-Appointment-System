  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        <div className='flex items-center gap-5 text-gray-500 mb-8'>
          ...
          <div className='w-full lg:flex-1 flex-col gap-4'>
            ...
            <div className='flex-1 flex flex-col gap-1'>
              ...
              <select onChange={(e) => setExperience(e.target.value)} value={experience}  className='border rounded px-3 py-2' name="" >
                ...
                <option value="! year">7 Year</option>
                <option value="! year">8 Year</option>
                <option value="! year">9 Year</option>
                <option value="! year">10 Year</option>
              </select>
            </div>
