    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          {/* about doctor */}
          <div>
            <p className='flex flex-center gap-1 text-sm font-medium text-gray-900 mt-3'>About <img src={assets.info_icon} alt="" />
            </p>
      ...
      {/* vooking slots */}
      <div className='sm:ml-72 ml:pl-4 mt-4 font-medium text-gray-700'>
        <p>Booking Slots</p>
